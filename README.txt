...
CyberSecurity:
  This folder is a collection of scripts made to help me learn about some cyber security things in July of 2023.
     ...
     - dictPasswordCracker:
        ...
        them to the list of 10 million passwords until a match is found. Printing out the password, the hashing algorithm used and 
        the hash value. 
...
Java:
  These 2 folders are from mid 2023, when I was studying OOP at univerity.
     ...
     - ComputerStoreSwingGUI:
        ...
        When run it propts the user to log in (there is not create user functionality currently, just already created users: 'm1','m2', 
        'p1', p2', 'p3'. The passwords are the user names respectively).
...
Python:
       ...
       - Runner game- pygames intro:
          ...
          Once spacebar is pressed the game starts and the music starts, the character starts running across the screen and enemies move 
